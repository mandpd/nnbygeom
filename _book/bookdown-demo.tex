...
\hypersetup{unicode=true,
            pdftitle={Learning Neural Networks},
            pdfauthor={Mark J Smith},
            pdfborder={0 0 0},
            breaklinks=true}
...
I'm writing it to discover more about the \href{https://github.com/karpathy/convnetjs}{convnetjs} package which provides a neural net implementation in javascript and the graphics package D3.
